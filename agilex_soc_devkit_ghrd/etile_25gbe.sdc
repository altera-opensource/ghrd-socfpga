...
set_false_path -from {*|etile_25gbe_1588|*|etile_hip_adapter_inst|tx_plldiv2_lock_reset_reg[5]} -to {*|altera_reset_synchronizer_int_chain[1]}

# False path between IO PLL Lock and ETILE reset synchronizer
set_false_path -from {*|etile_25gbe_1588|iopll_clk_avst_div2|*|tennm_pll~pll_e_reg__nff} -to {*|etile_hip_adapter_inst|tx_plldiv2_lock_reset_reg[*]}
